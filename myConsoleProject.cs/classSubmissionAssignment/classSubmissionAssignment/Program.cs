...
namespace classSubmissionAssignment
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            doDo.theThing(out int x);
            Console.WriteLine("First number entered was: {0}", num1);
            Console.WriteLine("Second number entered was: {0}", numNum);
            Console.ReadLine();

            Console.WriteLine("\n\n\nThanks for playing");  // This creates some space to make the exit message look nicer
            whatItDo.Nombre(name);  // This calls the Nombre function
