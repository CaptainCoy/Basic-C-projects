...
namespace DailyReport
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int page = Convert.ToInt32(Console.ReadLine());  // This converts the integer into a readable string

            Console.WriteLine("Do you need help with anything? Please answer \"true\" or \"false\".");  // Question.
            bool help = Convert.ToBoolean(Console.ReadLine());  // Answer. this converts the boolean into a readable string.
            ...
            Console.WriteLine("How many hours did you study today? (Numbers only)");  //Question.
            int studyTime = Convert.ToInt32(Console.ReadLine());  // Answer. This has to be a number entry.
